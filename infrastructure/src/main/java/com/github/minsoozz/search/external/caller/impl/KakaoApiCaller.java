 ...
 */
@Service
public class KakaoApiCaller implements ApiSpec {
    ...
    public ApiResponseDto searchBlogs(String query, final Integer page, final String sort) {
     ...
     */
    public ApiResponseDto fallback(String query, final Integer page, final String sort, Throwable t) {
